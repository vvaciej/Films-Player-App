		...
		<div className='space-light'>
			...
			<div className='content-full-space-centered'>
				<div className='search-wrapper'>
					<h1 className='text-3xl font-semibold'>Search results for: {params.query}</h1>
					<section className='search-movies-section'>
						<a href='#' className={`search-category-text flex items-center relative w-max ${searchResults.length > 0 ? 'active' : ''}`}>
						...
						<div className='search-movies-films-container'>
							{searchResults.map((film: FilmData, index: number) => (
								<article className='film-container' key={index}>
