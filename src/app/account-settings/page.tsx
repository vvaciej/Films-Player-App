						...
						<main className='w-full h-max flex flex-col gap-y-7'>
							...
							<div
								...
								<p className='mt-4 text-sm max-w-[40rem]'>
									...
									podczas uwierzytelniania. Możesz uzyskać ten token z aplikacji Google Authenticator swojego telefonu.
								</p>
							...
							<div
								...
								<p className='mt-4 text-sm'>
									...
									urządzeniach. Twoje ostatnie sesje są wymienione poniżej. Jeśli uważasz, że ktoś inny zalogował sie na
									twoje konto, powinieneś również zaktualizować swoje hasło. (Lokalizacje i adresy IP mogą być inne niż
									w rzeczywistości z powodu używania sieci VPN. Dzięki temu każdy użytkownik naszej strony jest
