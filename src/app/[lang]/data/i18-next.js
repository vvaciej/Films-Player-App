	...
	resources: {
		en: {
			translation: {
				...
				'Popularne filmy': 'Popular films',
				'Ostatnio dodane filmy': 'Lastly added films',
				'Popularne filmy akcji': 'Popular action films',
				'Popularne komedie': 'Popular comedies',
				'Popularne horrory': 'Popular horrors',
				'Popularne polskie filmy': 'Popular polish films',
				'Popularne seriale': 'Popular serials',
				// film titles
				'Śnieżne bractwo': 'Snowy brotherhood',
				'Skok w przestworzach': 'Lift',
				'Aquaman i Zaginione Królestwo': 'Aquaman and the Lost Kingdom',
				'Zabójcza gra': 'Role play',
				'Plan wycieczki': 'The Family Plan',
				'Rebel Moon - część 1: Dziecko Ognia': 'Rebel Moon - Part One: A Child of Fire',
				Życzenie: 'Wish',
				'Dotyk zła': 'The Creeping',
				'Każdy kłamie': 'Everyone lies',
				Pajęczyna: 'Spider web',
				'Zabójcza lekcja': 'Departing Seniors',
				'Bagażnik - uwięziona': 'Trunk - Locked In',
				'Myśliwi z ruin': 'Hunters from the ruins',
				Bękart: 'Bastard',
				Wizje: 'Visions',
				'Milion dni': 'Million days',
				'Jeszcze jeden strzał': 'One more shot',
				'Igrzyska śmierci: Ballada ptaków i węży': 'The Hunger Games: The Ballad of Songbirds & Snakes',
				...
				'Transformers: Przebudzenie bestii': 'Transformers: Rise of the Beasts',
				'Trolle 3': 'Trolls Band Together',
				...
				'Noc Dziękczynienia': 'Thanksgiving',
				'Meg 2: Głębia': 'Meg 2: The Trench',
				'Piła X': 'Saw X',
				'Raz, dwa, trzy... wchodzisz do gry!': 'All Fun and Games',
				'Egzorcysta: Wyznawca': 'The Exorcist: Believer',
				'Zakonnica II': 'The Nun II',
				'Egzorcysta Papieża': "The Pope's Exorcist",
				'Martwe Zło: Przebudzenie': 'Evil Dead Rise',
				'Małgorzata I: Królowa Północy': 'Margaret I: Queen of the North',
				'Poskromienie złośnicy 2': 'Taming of the Shrew 2',
				Znachor: 'Quack',
				Chłopi: 'Peasants',
				'Sieć podejrzeń': 'Web of suspicion',
				'Plan lekcji': 'Timetable',
				'Miłość do kwadratu': 'Love squared',
				Przestroga: 'Warning',
				'Obywatel Jones': 'Citizen Jones',
				'Rick i Morty': 'Rick and Morty',
				'Monarch: dziedzitwo potworów': 'Monarch: a legacy of monsters',
				Euforia: 'Euphoria',
				Niezwyciężony: 'Invincible',
				'Burmistrz Kingstown': 'Mayor of Kingstown',
				'Niebieskooki samuraj': 'BLUE EYE SAMURAI',
				'Nocny agent': 'The Night Agent',
				'Agentka McCall': 'The Equalizer',
				'Agenci NCIS: Hawaje': "NCIS: Hawai'i",
				// heading component
				...
				'Wyloguj sie': 'Logout',
				'Szukaj filmu lub serialu': 'Search movie or serial',
				Filmy: 'Films',
				Seriale: 'Serials',
				// not found page
				'Zabierz mnie tam!': 'Take me there!',
				...
				'Zaktualizuj informacje o swoim koncie.': 'Update informations about your account.',
				Informacje: 'Informations',
				'Logowanie przez inne portale': 'Social login',
				Hasło: 'Password',
				'Uwierzytelnienia dwuskładnikowe': 'Two-factor authentication',
				'Aktywne sesje': 'Active sessions',
				'Kraj i język': 'Country and language',
				'Usuń konto': 'Delete account',
				'Zaktualizuj imię nazwisko lub zdjęcie profilowe.': 'Update your name or profile picture.',
				Imię: 'Name',
				Nazwisko: 'Surname',
				'Zdjecie profilowe': 'Profile picture',
				'Usuń zdjęcie': 'Delete picture',
				Zapisz: 'Save',
				'Logowanie poprzez portale społecznościowe': 'Login through social networks',
				...
				'Zaktualizuj hasło i dane': 'Update password and informations',
				'Zaktualizuj hasło': 'Update password',
				...
				'Nie włączyłeś uwierzytelniania dwuskładnikowego.': 'You have not enabled two-factor authentication.',
				...
				'Wyloguj z innych sesji': 'Logout from other sessions',
				'Data, czas i język': 'Date, time and language',
				Język: 'Language',
				Kraj: 'Country',
				...
				// filtering
				'Najbardziej popularne': 'Most popular',
				'Najlepiej oceniane': 'Highest rating',
				'Najwiekszy przychod': 'Highest profit',
				'Najwiekszy budzet': 'Highest budget',
				'Ostatnio dodane': 'Lastly added',
				Siatka: 'Mesh',
				Pejzaz: 'Landscape',
				Lista: 'List',
				'Oceń to': 'Rate this',
				...
				Recenzja: 'Review',
				Tytuł: 'Title',
				'Dodaj recenzję': 'Add a review',
				'Recenzja przez': 'Review as',
				Najnowsze: 'Latest',
				Recenzje: 'Reviews',
				// forgot password
				...
				'Muzyczny': 'Musically',
				'Sci-Fi & Fantazja': 'Sci-Fi & Fantasy',
				'Dramat Historyczny': 'Historic drama',
				zastrzeżone: 'restricted',
				'filmy i seriale': 'movies and serials',
				...
				'Lub zarejestruj sie przez': 'Or login by',
				'Masz już konto?': 'Already have an account?',
				// results
				'Darmowe filmy i seriale': 'Free films and serials',
				Szukaj: 'Search',
				'Wyniki wyszukiwania:': 'Search results:',
				Filmy: 'Movies',
				// serials
				'Wyszukiwarka seriali': 'Search serials',
				Seriale: 'Serials',
				// film page
				Polski: 'Polish',
				'Obejrzyj potem': 'Watch later',
				Udostępnij: 'Share',
				'Skopiuj link': 'Copy link',
				'Udostępnij na facebooku': 'Share on facebook',
				'Udostępnij na twitterze': 'Share on twitter',
				'Oryginalny język': 'Original language',
				'Oryginalny tytuł': 'Original title',
				Budżet: 'Budget',
				Przychód: 'Profit',
				'Nakręcono w': 'Filmed in',
				'Słowa kluczowe': 'Keywords',
				Najnowsze: 'Latest',
				'Wymagana jest rejestracja': 'Register is required',
				lub: 'or',
				'stwórz konto': 'create account',
				'aby dodać recenzje': 'to add review',
				Źródła: 'Sources',
				'Pełne video': 'Full video',
				'Podobne filmy': 'Alike films',
				...
				Komentarze: 'Comments',
				Zaobserwuj: 'Follow',
				'o aktualizacje list, które utworzą w przyszłości.': 'for updates on lists they create in the future.',
				'Brak list': 'No list',
				'Brak ocen': 'No grades',
				'Brak recenzji': 'No reviews',
				'Brak komentarzy': 'No comments',
				'Brak obserwujących': 'No followers',
				'Nikogo jeszcze nie obserwuje': 'No followers yet',
				'Sprawdź później, aby zobaczyć użytkowników': 'Check back later to see users',
				obserwujących: 'is following',
				// watch page
				komentarzy: 'comments',
