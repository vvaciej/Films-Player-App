...
const SomethingDone = ({ visible, text }: any) => {
	...
	return (
		<div
			className={`fixed w-max h-max py-1 bg-red-300 bottom-7 translate-x-1/2 flex items-center justify-between rounded transition-all bg-1a1a outline-[1px] outline outline-gray3232 ${
				visible
